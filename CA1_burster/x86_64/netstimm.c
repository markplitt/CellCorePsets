...
#define nrn_init _nrn_init__NetStimm
#define _nrn_initial _nrn_initial__NetStimm
#define nrn_cur _nrn_cur__NetStimm
#define _nrn_current _nrn_current__NetStimm
#define nrn_jacob _nrn_jacob__NetStimm
#define nrn_state _nrn_state__NetStimm
#define _net_receive _net_receive__NetStimm 
#define event_time event_time__NetStimm 
#define init_sequence init_sequence__NetStimm 
#define seed seed__NetStimm 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 NetStimm /Users/markplitt/repos/CellCorePSets/CA1_burster/x86_64/netstimm.mod\n");
